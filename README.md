...
what3words UI is a lightweight library that comes with a suite of customizable android UI components that allows you to integrate the full functionalities of the what3words API without hassle. To get started you need to download this library and get your what3words developer API key by following this [link](https://what3words.com/select-plan).
